    ...
    <div className="product flex flex-col gap-2 bg-white shadow-lg rounded-xl overflow-hidden hover:shadow-2xl">
      ...
      <div className="texts flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="uppercase text-violet-50 bg-violet-500 font-medium py-3 px-8 rounded-md hover:bg-orange-500 hover:text-orange-50 duration-300 shadow-lg shadow-violet-300 hover:shadow-lg hover:shadow-orange-300">
            Add to cart
          </button>
        </div>
      </div>
